...
url = "https://apim.services.craneware.com/api-pricing-transparency/api/public/cc145ba21e574ef7da4a1ed8325d54f9/charges/standardCharges?page=0&limit=250&search=&codeType="
...
df.to_csv(r'Desktop\\marin.csv', index=False)
print(df.head)
